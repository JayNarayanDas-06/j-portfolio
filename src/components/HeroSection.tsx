      ...
      <div className="relative z-10 section-container">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="order-2 lg:order-1 text-center lg:text-left">
            ...
            duration: 0.5,
            delay: 0.2
          }} className="text-4xl md:text-5xl font-bold tracking-tight mb-2 lg:text-6xl">
            ...
            delay: 0.6
              ...
              {h.stats.map(stat => <div key={stat.label} className="text-center lg:text-left">
          ...
          delay: 0.2
            ...
            <div className="relative mx-auto w-72 h-72 md:w-96 md:h-96 lg:w-[450px] lg:h-[450px]">
              ...
              repeat: Infinity,
              ease: 'easeInOut'
            }} className="absolute -top-10 right-8 lg:-top-12 lg:right-4 p-3 rounded-xl bg-card border border-border shadow-lg">
              ...
              ease: 'easeInOut',
              delay: 0.5
            }} className="absolute top-1/4 -left-10 lg:-left-16 p-3 rounded-xl bg-card border border-border shadow-lg">
              ...
              ease: 'easeInOut',
              delay: 1
            }} className="absolute bottom-4 -right-10 lg:-right-16 p-3 rounded-xl bg-card border border-border shadow-lg">
