        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="order-2 lg:order-1 text-center lg:text-left">
            ...
            delay: 0.3
              ...
              <span className="hidden md:block text-muted-foreground">{h.titleSeparator}</span>
              <span className="text-lg text-muted-foreground md:text-2xl font-semibold">{h.subtitle}</span>
            </motion.div>
          ...
          delay: 0.2
            ...
            <div className="relative mx-auto w-72 h-72 md:w-96 md:h-96 lg:w-[450px] lg:h-[450px]">
              ...
              <div className="absolute inset-8 rounded-full overflow-hidden glow">
                <img alt={h.profileAlt} className="w-full h-full object-cover" src={h.profileImage} />
              </div>
              <motion.div animate={{
              y: [0, -10, 0]
            }} transition={{
