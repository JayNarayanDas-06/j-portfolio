          ...
          <div className="rounded-2xl bg-card border border-border overflow-hidden card-hover">
            ...
            <div className="p-6 md:p-8">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                {projectHighlightsMeta.map((item, index) => <motion.div key={item.label} initial={{ opacity: 0, scale: 0.9 }} animate={isInView ? { opacity: 1, scale: 1 } : {}} transition={{ duration: 0.3, delay: 0.3 + index * 0.1 }} className="text-center p-4 rounded-xl border border-border bg-secondary/30">
