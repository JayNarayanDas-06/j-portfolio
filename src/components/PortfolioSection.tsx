            ...
            <div className="relative z-10 rounded-t-2xl bg-primary overflow-hidden pt-4">
              <div className="px-6 py-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={handleTogglePreview} className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary-foreground/10 hover:bg-primary-foreground/20 transition-colors font-medium text-primary-foreground text-sm">
                      Project Preview
