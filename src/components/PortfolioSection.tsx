...
const achievements = ['Improved keyword rankings across targeted search terms', 'Increased user engagement and brand visibility', 'Developed strategic social media marketing campaigns', 'Expanded digital reach through SEO-driven content'];
           ...
           <div className="rounded-2xl bg-card border border-border overflow-hidden card-hover">
             ...
             <div className="p-6 md:p-8">
               ...
               <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                 {projectHighlights.map((item, index) => <motion.div key={item.label} initial={{
                opacity: 0,
                scale: 0.9
              }} animate={isInView ? {
                opacity: 1,
